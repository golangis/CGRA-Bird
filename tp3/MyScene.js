...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.prism = new MyPrism(this, 3, 3);
    ...
    updateGlobalIlumination() {
        this.setGlobalAmbientLight(this.globalIlumination, this.globalIlumination, this.globalIlumination, 1.0)
    }
    ...
    initMaterials() {
        ...
        this.materials = [this.material1, this.material2, this.material3, this.customMaterial, this.myMaterial];

        // Labels and ID's for object selection on MyInterface
        this.materialIDs = {'Red Ambient': 0, 'Red Diffuse': 1, 'Red Specular': 2, 'Custom': 3, 'My Material': 4};
    }
    display() {
